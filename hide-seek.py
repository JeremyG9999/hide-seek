...
class Hide_And_Seek:
    def __init__(self):
        self.reset_game()
    def reset_game(self):
        self.choice = self.room_guess = None
    ...
    def round_summary(self):
        ...
        if self.room_guess not in [self.choice1, self.choice2, self.choice3, self.choice4]:
